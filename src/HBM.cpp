...
void HBM::init_lambda()
{
    ...
    //TODO : add lambda for Newton GWRITE, G_ACT0, G_ACT1, G_ACT2, G_ACT3, COMP, ACT_OP, READRES,
    ...
    lambda[int(Level::Rank)][int(Command::ACT_OP)] = [] (DRAM<HBM>* node, int id) {/*std::cout<<"ACT_OP"<<std::endl;*/};
